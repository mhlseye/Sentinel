...
//        }
        try {
            ...
            logger.warn("publish gateway apis fail after add: {}", e.getMessage());
        }
...
//        }
        try {
            ...
            logger.warn("publish gateway apis fail after update: {}", e.getMessage());
        }
...
//        }
        try {
            ...
            logger.warn("publish gateway apis fail after delete: {}", e.getMessage());
        }
...
//    }
    ...
    private void publishApis(String app) throws Exception {
        ...
        apiPublisher.publish(app,rules);
    }
}
