...
//        }
        try {
            ...
            logger.warn("publish gateway flow rules fail after add: {}", e.getMessage());
        }
...
//        }
        try {
            ...
            logger.warn("publish gateway flow rules fail after update: {}", e.getMessage());
        }
...
//        }
        try {
            ...
            logger.warn("publish gateway flow rules fail after delete: {}", e.getMessage());
        }
